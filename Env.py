...
class CabDriver():
    ...
    def __init__(self):
        ...
        #self.action_space = [(0,0),(1,2),(1,3),(1,4),(1,5),(2,1),(2,3),(2,4),(2,5),(3,1),(3,2),(3,4),(3,5),(4,1),(4,2),(4,3),(4,5)]
    ...
    def reward_func(self, wait_time, transit_time, ride_time):
       ...
       # current_state, wait_time, transit_time, ride_time = self.next_state_func(self, state, action, Time_matrix)
        travel_time = ride_time
        idle_time = wait_time + transit_time
        
        reward = (R * travel_time) - (C * (travel_time + idle_time))
        return reward
    ...
    def step(self, state, action, Time_matrix):
            """
            Step function to calculate total reward for the trip as cabby to get rewards next step and total time spent
            """
